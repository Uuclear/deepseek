...
| 文件 / 目录 | 用途 | 关联章节 |
|-------------|------|----------|
| `corpus_zh_en.txt` | 中英文混合语料（~50KB），训练 BPE 分词器 | Part 8 §08-01 |
| `sft_instructions.jsonl` | 55 条 Alpaca 格式中文指令数据 | Part 8 §08-05 |
...
| `sample_docs/` | 5 篇 AI 教程片段（Markdown/TXT） | Part 9 RAG 示例 |
