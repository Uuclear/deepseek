...
const examplesUrl = 'https://github.com/Uuclear/deepseek/tree/main/examples'

// Markdown 插件：Mermaid 流程图（withMermaid 包装）+ KaTeX 数学公式（$inline$ / $$block$$）
export default withMermaid(
  defineConfig({
    ...
    themeConfig: {
      logo: '/logo.svg',
      nav: [
        { text: '开始学习', link: '/part-00-env/01-python-install' },
        { text: '学习地图', link: '/visuals/learning-map' },
        { text: '路线图', link: '/roadmap' },
        { text: '示例代码', link: examplesUrl },
        { icon: 'github', link: 'https://github.com/Uuclear/deepseek' },
      ],

      sidebar: {
        '/part-00-env/': partSidebar('🛠️ Part 0 环境与工具', [
        ...
        '/part-08-llm-build/': partSidebar('🔧 Part 8 从零构建大模型', [
          ...
          ['09-distributed-training', '分布式训练入门'],
          ['10-quantization-export', '模型量化与导出'],
        ]),
        '/part-09-agents/': partSidebar('🤖 Part 9 AI Agent 开发', [
          ...
          ['09-agent-eval-safety', 'Agent 评测与安全'],
          ['10-knowledge-agent-project', '实战：个人知识库 Agent'],
        ]),
        '/part-10-advanced/': partSidebar('🎯 Part 10 进阶专题', [
          ['01-grpo-rl-intuition', 'GRPO / RL 直觉'],
          ['02-moe-deepseek-arch', 'MoE 与 DeepSeek 架构'],
          ['03-distillation-practice', '蒸馏 Teacher-Student'],
          ['04-vllm-deployment', 'vLLM 推理部署'],
          ['05-multimodal-intro', '多模态入门'],
        ]),
        '/visuals/': [
          {
            text: '🗺️ 可视化',
      ...
      footer: {
        message: '从零开始学 AI · 构建 LLM · Agent 开发 · DeepSeek 实战',
        copyright: 'Copyright © 2024–2026 Uuclear · MIT License · 页面底部显示最后更新时间',
      },
    },
  }),
  {
