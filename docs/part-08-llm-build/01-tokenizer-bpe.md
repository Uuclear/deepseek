...
> **前置知识**：[Part 5 分词与 Embedding](/part-05-nlp/01-tokenization-embedding)  
> **预计时间**：90 分钟  
> **本章产出**：在真实小语料上训练并保存 BPE 分词器
...
我们使用仓库原创语料 [`data/corpus_zh_en.txt`](/data/corpus_zh_en.txt)（中英文混合，约 50KB）。
...
- [`examples/part-08-llm-build/train_tokenizer.py`](/examples/part-08-llm-build/train_tokenizer.py)
- [`examples/part-08-llm-build/README.md`](/examples/part-08-llm-build/README.md)
- 数据：[`data/corpus_zh_en.txt`](/data/corpus_zh_en.txt)
